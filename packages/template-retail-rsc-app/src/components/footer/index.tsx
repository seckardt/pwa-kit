...
import {BsYoutube, BsInstagram, BsTwitterX, BsFacebook} from 'react-icons/bs';
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <div className="flex space-x-4">
                            <a href="https://youtube.com/channel/UCSTGHqzR1Q9yAVbiS3dAFHg" aria-label="Youtube" className="text-white hover:underline"><BsYoutube/></a>
                            <a href="https://instagram.com/commercecloud" aria-label="Instagram" className="text-white hover:underline"><BsInstagram/></a>
                            <a href="https://x.com/CommerceCloud" aria-label="X" className="text-white hover:underline"><BsTwitterX /></a>
                            <a href="https://facebook.com/CommerceCloud/" aria-label="Facebook" className="text-white hover:underline"><BsFacebook/></a>
                        </div>
                        <div className="mt-4">

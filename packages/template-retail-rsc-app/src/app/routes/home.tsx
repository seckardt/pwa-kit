...
export default function Home() {
    return (
        <>
            <Hero
                title="The NextGen React PWA Starter Store for Retail"
                subtitle="Discover our latest collection of products"
                imageUrl="/images/hero.png"
                imageAlt="Hero banner showing products"
                ctaText="Shop Now"
                ...
                <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="mt-12 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                        ...
                        <div className="bg-gray-50 p-6 rounded-lg">
                            ...
                            <p className="text-gray-600">
                                Deliver the next best product or offer to every shopper through
                        ...
                        <div className="bg-gray-50 p-6 rounded-lg">
                            ...
                            <p className="text-gray-600">
                                Shoppers can manage account information such as their profile,
                                addresses, payments and orders.
                            </p>
                        </div>
                        ...
                        <div className="bg-gray-50 p-6 rounded-lg">
                            ...
                            <p className="text-gray-600">
                                Registered shoppers can add product items to their wishlist from
                                purchasing later.
                            </p>
                        </div>
                    </div>
